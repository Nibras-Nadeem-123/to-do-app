...
export default function Home() {
  ...
  return (
    ...
    >
      ...
      <div className="p-10 text-black ml-10">
        <div className={` relative  ${isDarkMode
          ? "bg-black/30"
          : "bg-white/20"
          } lg:max-w-4xl xl:max-w-5xl mx-auto md:max-w-3xl text-center sm:max-w-2xl p-8`}>

          <div className={`flex flex-row gap-16 ml-16`}>
            <button
              onClick={toggleTheme}
              className={`p-3 text-xl rounded-md shadow-md ${isDarkMode
                ? " shadow-gray-700 bg-gray-50 text-black"
            ...
            <div className="relative text-center">
              <div className="relative inline-block group">
                ...
                {showDropdown && (
                  <div
                    className={`absolute left-0 max-w-4xl mt-2 w-64 max-h-64 mx-auto overflow-auto bg-white border rounded-md shadow-lg group-hover:block hidden
            ...
            <div>
               <ul className="ml-10 text-[18px]">
                <li className={`text-red-600 ${isDarkMode
                  ? "text-shadow-custom-light"
                  : "text-shadow-custom-dark"}`}>Urgent or require immediate attention.</li>
                <li className={`text-yellow-600 ${isDarkMode
                  ? "text-shadow-custom-light"
                  : "text-shadow-custom-dark"}
                  `}> important but not as urgent.</li>
                <li className={`text-green-700 ${isDarkMode
                  ? "text-shadow-custom-light"
                  : "text-shadow-custom-dark"}
                  `}>can be done later or have minimal urgency.</li>
               </ul>
            </div>
          </div>
          ...
          <div className=" relative">
            ...
            <button
              onClick={addTask}
              className={`relative bg-blue-700 hover:bg-blue-600 p-2 text-[20px] m-2 lg:w-[20%] lg:p-2 md:w-[18%] md:p-1 sm:w-[14%] sm:p-0 shadow-md shadow-gray-800  ${isDarkMode
                ? " shadow-gray-700"
                : "  shadow-white"
        ...
        <div className={` relative grid lg:grid-cols-2 ${isDarkMode
          ? " shadow-white text-black bg-black/30"
          : "  shadow-gray-700 text-white bg-white/20"
          }  md:grid-cols-2 lg:mr-[18%] lg:ml-[18%] md:m-2 sm:grid-cols-1 gap-10 xl:max-w-[3xl] lg:max-w-[2xl] md:max-w-[xl] sm:max-w-[lg] mx-auto p-8`}>
          {todoList.length === 0 ? (
            ...
            todoList
              ...
              .map((todo, i) => (
               ...
               ${isDarkMode
                    ? " shadow-gray-700"
                    : "  shadow-white"
                  } bg-amber-100 w-full sm:p-3 md:p-4 p-5`}>
                  <div>
                    {
                  ...
                  <div className=" relative flex flex-row justify-between gap-2 text-black">
                    <input
                      onChange={() => completedTask(todo.id)}
                      type="checkbox"
                      className="relative w-8 h-8 m-2 rounded-full border-2 border-gray-500 focus:ring-2 focus:ring-blue-500"
                    />
                    ...
                    <div className="text-right">
                      <span
                        ...
                        className="bg-green-700 hover:bg-green-600 text-shadow-custom-dark cursor-pointer shadow-md shadow-green-800 p-3 m-2 mt-10 rounded-full lg:text-xl md:text-lg sm:text-sm text-white"
                      >
                        Edit
                      </span>
                      <span
                        onClick={() => deleteItem(todo.id)}
                        className="shadow-md shadow-red-700 rounded-full bg-red-600 hover:bg-red-500 cursor-pointer text-shadow-custom-dark p-3  mr-5 mt-10 text-white text-xl text-center my-auto"
                      >
                        X
                      </span>
                    </div>
